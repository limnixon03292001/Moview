        ...
        <div className='flex px-2 lg:px-0 md:mx-6 md:space-x-4'>
            ...
            <div className='px-4 space-y-3'>
                <div className='space-y-1'>
                    <h1 className='text-3xl text-[#343333] dark:text-[#F5F7FA]'>{data?.data?.title}</h1>
                    <p className='text-[#4F4D4D] font-light dark:text-[#BCCCDC] text-sm'>{data?.data?.tagline}</p>
                </div>
                <div className='relative w-full overflow-hidden'>
                    <p className='text-[#4F4D4D] font-light dark:text-[#BCCCDC] text-sm'>{data?.data?.overview}</p>
                </div>
            </div>
        </div>
    </div>

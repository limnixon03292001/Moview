    ...
    <div className='md:my-3 md:mx-7'>
      <div className='max-w-[410px] h-[47px] relative'>
        ...
        <div className='h-full w-full relative'>
          <input type="text" className='drop-shadow-md bg-white dark:bg-[#323F4B] px-4 pr-7 py-2 rounded-lg w-full h-full dark:text-[#E4E7EB] outline-none focus:ring focus:ring-[#E4E7EB]' placeholder='Search movie...' name='search' onChange={(e) => setSearchData(e.target.value)} value={searchData} />
